# Contributing Guide to `@reason-react-native/datetimepicker`
...
Just try to
[open a new issue](https://github.com/reason-react-native/datetimepicker/issues/new/choose)
...
```console
git clone https://github.com/reason-react-native/datetimepicker
cd datetimepicker
yarn
```
